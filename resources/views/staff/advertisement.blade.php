			...
			<table class="table table-bordered">
				...
				<tbody>
					...
					<tr id="advertisement{{$adv->advertisement_id}}">
						...
						<td>{{$adv->staff_id}}</td>
						<td width="150">
							<button class="btn btn-warning btn-xs btn-detail open_modal" value="{{$adv->advertisement_id}}">
								Update
							</button>
							<button class="btn btn-danger btn-xs delete-adver" value="{{$adv->advertisement_id}}">Delete</button>
						</td>
					</tr>
					@endforeach	
				</tbody>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form class="form-horizontal" id="frmAdver" name="frmAdver" novalidate="">
					...
					<input type="hidden" id="staff_id" name="staffid" value="admin">
				</form>
