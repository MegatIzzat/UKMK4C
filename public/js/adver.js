    ...
    $(document).on('click','.open_modal',function(){
        ...
        $.get(url + '/' + advertisement_id, function (data) {
            ...
            // $('#advertisement_id').val(data.advertisement_id);
    ...
    $("#btn-save").click(function (e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                advertisement += '<td><button class="btn btn-warning btn-detail open_modal" value="' + data.advertisement_id + '">Edit</button>';
                advertisement += ' <button class="btn btn-danger btn-delete delete-advertisement" value="' + data.advertisement_id + '">Delete</button></td></tr>';
